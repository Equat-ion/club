...
/**
 * Renders a plugin card with status, controls, and a confirmation dialog for toggling the plugin.
 *
 * Shows plugin name, icon (if available), enabled/disabled badge, version, description, and a settings button.
 * When the switch is interacted with, a confirmation dialog is opened; confirming the dialog invokes `onToggled`.
 *
 * @param plugin - The installed plugin to display.
 * @param orgId - Organization identifier used when interacting with the toggle dialog.
 * @param orgSlug - Organization slug used when interacting with the toggle dialog.
 * @param onToggled - Callback invoked when the plugin's enabled state is confirmed; called with `(pluginId, newEnabled)`.
 * @returns The rendered plugin card element.
 */

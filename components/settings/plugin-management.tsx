...
/**
 * Format a date as a short US locale string (e.g., "Mar 5, 2026").
 *
 * @param date - The date to format
 * @returns The formatted date string in "Mon DD, YYYY" style (e.g., `Mar 5, 2026`)
 */
...
/**
 * Render a table row for an installed plugin including its icon, description, installed date, and controls to open a confirmation dialog for enabling or disabling the plugin.
 *
 * @param plugin - The installed plugin to display
 * @param orgId - Organization numeric id used by the toggle dialog
 * @param orgSlug - Organization slug used by the toggle dialog
 * @param onToggled - Callback invoked with `(pluginId, enabled)` when a toggle is confirmed
 * @returns A JSX element containing the plugin's table row and the conditional toggle confirmation dialog
 */
...
/**
 * Render the plugin management interface for an organization.
 *
 * Renders a table of installed plugins, allows toggling a plugin's enabled state (opens a confirmation dialog before applying), and displays an empty-state when no plugins are installed.
 *
 * @param initialPlugins - Initial list of installed plugins to display
 * @param orgId - Organization identifier used when performing plugin actions
 * @param orgSlug - Organization slug used when performing plugin actions
 * @returns The React element containing the plugin management UI
 */
